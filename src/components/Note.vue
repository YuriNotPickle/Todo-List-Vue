<template>
  <div>
    ...
    <transition name="todo-list" mode="out-in">
      ...
      />
      <div v-else class="card todo-list-empty">Empty</div>
    </transition>
    <div class="note-actions">
      <button class="button button-red" @click="undo" :disabled="!canUndo">↶</button>
      <button class="button button-green" @click="redo" :disabled="!canRedo">↷</button>
      <button class="button button-green" @click="save" :disabled="!didChanged">save</button>
      <button class="button button-red" @click="askForDiscard" :disabled="!didChanged">discard</button>
